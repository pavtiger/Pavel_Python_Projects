...
class Example(QWidget):
    ...
    def mouseMoveEvent(self, event):
        ...
        if self.LastMousePosition.x() - CurrentPos.x() + self.LastMousePosition.y() - CurrentPos.y() < 50:
            print(CurrentPos)
            print(self.LastMousePosition)
            print('')
            self.DeltaX -= self.LastMousePosition.x()-CurrentPos.x()
            self.DeltaY -= self.LastMousePosition.y()-CurrentPos.y()
