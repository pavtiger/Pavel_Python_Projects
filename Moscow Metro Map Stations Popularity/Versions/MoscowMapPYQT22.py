...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        print(len(stationsName))
        for StationsI in range(len(stationsName)):
            print(stationsName[StationsI])
            self.Size = list(self.GetStationPopularity([stationsName[StationsI]], self.pytrends))
            print(self.Size)
